...
},{"axios":"../../node_modules/axios/index.js","./alert":"alert.js"}],"MercadoPago.js":[function(require,module,exports) {
"use strict";
...
var mp = new MercadoPago('TEST-f19382a2-a1df-466d-9f9b-5090a335c9a7', {
  locale: 'es-AR'
});
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(tourID) {
    var container, session, checkout, bookBtn;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          container = document.querySelector('.checkout-container'); // 1) Get checkout session from API
          _context.prev = 1;
          _context.next = 4;
          return (0, _axios.default)({
            method: 'GET',
